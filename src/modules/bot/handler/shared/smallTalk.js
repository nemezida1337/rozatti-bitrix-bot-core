...
const TOPIC_PATTERNS = [
  ...
  { topic: "PAYMENT", regex: /(оплат|предоплат|счет|сч[её]т|карт|перевод|налич|реквизит|задаток|доплат|стоим|цена|сколько)/i },
  { topic: "DELIVERY", regex: /(достав|получ|самовывоз|курьер|пвз|пункт выдач|сд[эе]к|делов(ые)?\s+линии|тк|обреш[её]тк|упаковк|страховк)/i },
